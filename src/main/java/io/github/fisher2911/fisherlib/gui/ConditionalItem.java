...
import io.github.fisher2911.fisherlib.config.condition.ItemConditional;
...
public class ConditionalItem {
    ...
    public BaseGuiItem getItem(Metadata metadata) {
        ...
        return GuiItem.air(this.plugin);
    }
    ...
    public static class Builder {
        ...
        public ConditionalItem build() {
            return new ConditionalItem(this.plugin, this.metadata, this.conditionalItems, this.placeholders);
        }
