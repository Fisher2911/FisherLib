...
public abstract class BaseGui implements InventoryHolder {
    ...
    public BaseGui(
        ...
        this.metadata.set(GuiKey.GUI, this);
        this.id = id;
        this.name = name;
        this.rows = rows;
        this.guiItemsMap = guiItemsMap;
        final List<Object> placeholders = GuiKey.toPlaceholders(this.metadata);
        this.repeatPageSlots = repeatPageSlots;
        this.inventory = Bukkit.createInventory(
                this,
                this.rows * 9,
                MessageHandler.serialize(this.plugin.getPlaceholders().apply(this.name, placeholders.toArray()))
        );
